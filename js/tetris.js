...
function keyDownEventHandler(e) {
    switch (e.keyCode) {
        case 37: setTimeout("moveLR(-1)", 0); break; //좌
        case 39: setTimeout("moveLR(1)", 0); break; // 우
        case 32: setTimeout("rotateShape()", 0); break; // 스페이스바
        case 40: moveFast(); break; // 하
    }
}
...
function drawField() {
    ...
    for (var i = 0; i < H; i++) {
        ...
        for (var j = 0; j < W; j++) {
            asdf++;
            fieldTag += "<td id=\"" + String(i) + " " + String(j) + "\"class=\"a" + String(asdf) + "\"></td>";
        }
        fieldTag += "</tr>";
    }
