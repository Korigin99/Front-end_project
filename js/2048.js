...
function coloring(cell) {
  ...
  switch (cellNum) {
    case 0:
    case 2:
      cell.style.background = "#f03d19";
      break;
    case 4:
      cell.style.background = "#f07d19";
      break;
    case 8:
      cell.style.background = "#e2e825";
      break;
    case 16:
      cell.style.background = "#87d929";
      break;
    case 32:
      cell.style.background = "#29d935";
      break;
    case 64:
      cell.style.background = "#29d981";
      break;
    case 128:
      cell.style.background = "#29cdd9";
      break;
    case 256:
      cell.style.background = "#2975d9";
      break;
    case 512:
      cell.style.background = "#1d0c7a";
      break;
    case 1024:
      cell.style.background = "#8b1de0";
      break;
    case 2048:
      cell.style.background = "#e01d9c";
      break;
    default:
      if (cellNum > 2048) {
        cell.style.background = "#0040b6";
      } else {
        cell.style.background = "#f4f4fc";
      }
      break;
  }
}
